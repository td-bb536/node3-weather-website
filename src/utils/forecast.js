...
const forecast = (latitude, longitude, callback) => {//8cf78b463a4dccfca6ef49cda44bf3a0
    const url = 'http://api.weatherstack.com/current?access_key=1a41209dffc50f7ae868d95074dd3132&query=' + latitude + ',' + longitude + '&units=m'
